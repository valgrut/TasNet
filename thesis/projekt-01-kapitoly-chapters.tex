...
Má práce s názvem "Separace mluvčích v časové doméně" má za cíl zreplikovat výsledky studie\ref{referencni_studie}, kde se hluvoká neuronová síť dokázala naučit separovat dva mluvčí jež jsou zaznamenaní na jednokanálové nahrávce pomocí konvolučního autoenkodéru a hlubokých konvolučních sítí, které dokážou udržovat závislosti ve zpracovávaném vstupním vzorku.
