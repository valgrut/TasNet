...
python3 main.py --test --R 2 --X 2 --basepath="$HOME/Documents/full/min/" --load-checkpoint="$HOME/TEST/tasnet_model_checkpoint_2020-02-12_11:03_X2_R2_e0_a6.tar" --minibatch-size 1
