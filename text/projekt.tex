...
\projectinfo{
  ...
  keywords.cs={neuronové sítě, zpracování řeči, konvoluční neuronová síť, autoenkodér, separace mluvčích, strojové učení, tasnet, hluboké učení}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={artificial neural networks, speech processing, convolutional neural networks, autoencoder, speech separation, machine learning, tasnet, deep learning}, % klíčová slova v anglickém jazyce / keywords in english
