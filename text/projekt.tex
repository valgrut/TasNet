...
\projectinfo{
  ...
  keywords.cs={neuronové sítě, zpracování řeči, konvoluční neuronová síť, autoenkodér, separace mluvčích, strojové učení, tasnet}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={neural networks, speech processing, convolutional neural networks, autoencoder, speech separation, machine learning, tasnet}, % klíčová slova v anglickém jazyce / keywords in english
  ...
  \todo {Jeste neco? 4. cast?}

  \todo {Doplnit SDR presnost do odstavce vyse.}
