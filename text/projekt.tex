...
\projectinfo{
  ...
  keywords.cs={Neuronová síť, konvoluční neuronová síť, autoenkodér, separace mluvčích, časová doména, ...}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={Neural networks, convolutional neural networks, autoencoder, speech separation, time domain, ...}, % klíčová slova v anglickém jazyce / keywords in english
