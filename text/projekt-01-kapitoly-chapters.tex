...
\todo{sem mozna jeste zminit tu cast pred TCN a softmax a pod. po TCN}
...
\todo{pridat dilation factor 2 mocnina X minus 1 do obrazku stacked--resblocks jpg}
\begin{figure}[H]
    \centering
...
\subsection{Konvoluční bloky - mozna pryc}
...
\section{Normalizace}
\todo{vzorecek pouzite normalizacni metody MOZNA, popsat i to s cim jsem ja osobne neexperimentoval?}
Vzhledem ke změnám distribuce vstupních dat mezi jednotlivými vrstvami, se trénování sítí stává složitější a je nutné
