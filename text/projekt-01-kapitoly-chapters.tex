...
\todo{popsat obrazky, mozna nektere zcuknout k sobe nebo vedle sebe}

Na začátku separačního modulu je přidána lineární operace $1 \times 1$--conv jako bottleneck, která určuje počet kanálů na vstupu a výstupu následujících konvolučních bloků.
...
\begin{figure}[H]
    ...
    \caption{\label{fig:tasnet-stacked-resblocks}TODO\todo{pridat dilation factor 2 mocnina X minus 1 do obrazku stacked--resblocks jpg}TODO}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\label{fig:tasnet-convblock}Jeden konvoluční blok\todo{graficky zde ukazat a zakrouzkovat co je sconv a co je dconv}}
\end{figure}
...
\todo{zaver kapitoly}
V této kapitole byla popsána architektura TasNet a její výhody oproti dosavadním metodám, které v mnoha směrech značně předčila a díky níž se algoritmy pohnuly opět o krok blíž ke stavu, kdy je bude možné využít na běžně dostupných zařízeních.
