...
\todo{obrazek spektrogramu reci}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{obrazky-figures/spektrum.png}
...
\todo{tento obrazek - levej a pravej}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{obrazky-figures/cnnfeatures.png}
...
\todo{Prepsat a nekam dat nasledujici odstavec.}
