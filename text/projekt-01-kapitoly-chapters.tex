...
Pro vyhodnocení kvality separace se používají metriky.
...
\label{implementace}
\todo{Úvod - Pozn: colab + stroj, pytorch, bash, konkretni hyperparams, vykon a cas trenovani, seg--len, popis trid.}.
...
\todo{obrazek hierarchie adresářů v rámci úvodu}

\section{Implementace modelu}
\todo{Pozn: pytorch, scripty, python3, bash, tridy, moduly, parametry a volby spusteni.}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.60]{obrazky-figures/segmentation.jpg}
