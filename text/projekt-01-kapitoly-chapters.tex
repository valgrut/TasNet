...
\todo{Mozna sjednotit X a R podkapitoly - vysledky by byly stejne, jen v jinem poradi v tabulkach}
...
\subsection{Vliv hyper--parametru X a R}

\begin{table}[hbt]
\centering
\caption{Tabulka zobrazující vliv počtu konvolučních bloků X na výsledky testování}
\label{tab:vliv-X}
\begin{tabular}{|l|l|l|l|l|l|}
\hline
\textbf{X} & \textbf{R} & \textbf{Délka segmentů} & \textbf{SDR {[}dB{]}} & \textbf{STOI} & \textbf{PESQ} \\ \hline
8 & 4 & 32000 & 12.00 & 0.00 & 2.00 \\ \hline
8 & 4 & 32000 & 12.00 & 0.00 & 2.00 \\ \hline
\end{tabular}
\end{table}
...
\todo{zmensovani a zvetsovani SL, vysledky testovani, nejake fajnove grafy porovnani vysledky mezi jednotlivymi SL, obrazky, grafy, histogramy pohlavi}
...
\todo{shrnuti a porovnani jednotlivych zmen a vysledku mezi sebou komplexne. Pripadne porovnani vysledku s~ref studii, obrazky, grafy. Okomentovat, co je tedy dulezity parametr, a ktery jde zmensit a neni moc dulezity z~pohledu vysledku evaluace.}

histogram vysledku skrze jednotlive promluvy, zjistit pomery jeslti je lepsi vysledky muz zena nebo muz muz. Zkusit to treba pro nejlepsi model, pripadne pro nejakej jeden mensi.
