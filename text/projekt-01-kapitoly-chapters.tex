...
Hyperparametry jsou parametry určující nastavení neuronové sítě. Tyto parametry musí být určeny před začátkem trénování a nelze je později měnit. Mohou určovat například počet skrytých vrstev, velikost záběrného pole, velikost filtrů a další.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{obrazky-figures/capacity_vs_error.svg}
    \caption{\label{fig:gradientdescent}Vliv kapacity modelu trénovací a testovací chybu}
\end{figure}


\subsection{Regularizace}
Regularizace je souhrn postupů, které slouží k zabránění přeučení nebo podučení.
