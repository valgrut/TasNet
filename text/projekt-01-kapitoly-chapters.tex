...
\todo{zmensovani a zvetsovani X, vysledky testovani, nejake fajnove grafy porovnani vysledky mezi jednotlivymi X, obrazky, grafy pro sdr, pesq, stoi}
\todo{histogram vysledku skrze jednotlive promluvy, }
...
\todo{popsat obrazek a blah jsou dokonce nahravky, ktere dosahly hodnoty sdr vetsi nez 18, ale nejvetsi koncentrace je kolem hodnoty sdr XX.}
...
\todo{jaky param ma tedy nejvetsi vliv na presnost. jestli ma vliv segmentlen, jakou kombinaci pohlavi sit nejlepe rozdeluje. Jake parametry bych mohl zmensit, aby model porad mel dobrou presnost ale byl mensi.}
